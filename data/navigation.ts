...
export const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: label("Develop Players & Teams", "พัฒนาผู้เล่นและทีม"), href: "/what-we-do/develop-players-teams" },
      { label: label("Support & Improve Airsoft and Paintball Fields", "สนับสนุนและยกระดับสนามแอร์ซอฟต์และเพ้นท์บอล"), href: "/what-we-do/support-improve-fields" },
      { label: label("Organize Professional Competitions & Events", "จัดการแข่งขันและอีเวนต์อย่างมืออาชีพ"), href: "/what-we-do/organize-competitions-events" },
      { label: label("Build a Pathway to International Competition", "สร้างเส้นทางสู่การแข่งขันระดับนานาชาติ"), href: "/what-we-do/build-pathway-competition" },
      { label: label("Strengthen the Airsoft & Paintball Community", "สร้างความเข้มแข็งให้กับชุมชนแอร์ซอฟต์และเพ้นท์บอล"), href: "/what-we-do/strengthen-community" },
      { label: label("Promote Teamwork, Leadership & Sportsmanship", "ส่งเสริมการทำงานเป็นทีม ภาวะผู้นำ และน้ำใจนักกีฬา"), href: "/what-we-do/promote-teamwork-leadership" },
      { label: label("Promote Thailand as the Airsoft & Paintball Hub of Asia", "ผลักดันประเทศไทยสู่การเป็นศูนย์กลางแอร์ซอฟต์และเพ้นท์บอลแห่งเอเชีย"), href: "/what-we-do/promote-thailand-hub" },
      { label: label("Advance Airsoft & Paintball as Recognized Sports", "ผลักดันแอร์ซอฟต์และเพ้นท์บอลสู่การเป็นกีฬาที่ได้รับการยอมรับ"), href: "/what-we-do/recognized-sports" },
    ],
  },
  {
