...
export const navigation: NavItem[] = [
  ...
  { label: label("UPCOMING EVENTS", "กิจกรรมและอีเวนต์ที่กำลังจะมาถึง"), href: "/events" },
  {
    ...
    children: [
      ...
      { label: label("Minimum Engagement Distance", "ระยะการยิงขั้นต่ำ"), href: "/rules-safety/engagement-distances" },
      ...
      { label: label("International Standard", "มาตรฐานระดับนานาชาติ"), href: "/rules-safety/international-standards" },
