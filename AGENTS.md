...
- Supplied association logo appears in both header and actual footer across every route at identical sizes: 192px above 480px viewport width, 136px at or below 480px. No visible association-name text. The latest user request restores the header logo.
