...
export function UpcomingEvents() {
  ...
  return <section className={styles.upcoming}><div className={styles.sectionHead}><p className="eyebrow">CALENDAR</p><h2>UPCOMING<br />EVENTS</h2></div>
    <div className={styles.railStage}><div className={styles.railControls} aria-label="Event carousel controls"><button onClick={() => move(-1)} aria-label="Previous event"><span className={styles.swipeLabel}>SWIPE</span> ←</button><button onClick={() => move(1)} aria-label="Next event">→ <span className={styles.swipeLabel}>SWIPE</span></button></div>
