...
export function SiteHeader() {
  ...
  return <header className={styles.header}><div className={styles.bar}>
    <Link className={styles.brand} href="/" aria-label="Thailand Airsoft Association home"><Image src="/images/association-logo.png" alt="Thailand Airsoft Association" width={48} height={48} priority /><span>THAILAND AIRSOFT<br />ASSOCIATION</span></Link>
